...
render() {
  ...
  const confirmMessage = data.sanityNewsletterSignup.mailchimpSignupConfirmation
  const errorMessage = data.sanityNewsletterSignup.mailchimpSignupError
  const heading = data.sanityNewsletterSignup.headline
  const subheading = data.sanityNewsletterSignup.subheading
...
export default props => (
  <StaticQuery
    query={graphql`
      query {
        sanityNewsletterSignup(_id: {regex: "/(drafts.|)newsletterSignup/"}) {
