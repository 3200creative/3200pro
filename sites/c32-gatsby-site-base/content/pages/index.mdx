...
<Hero
  titleText="Boom! Gatsby at Turbospeed!"
  buttonText="Start your engines"
  buttonLink="https://www.google.com"
/>

# C32 Gatsby site Base

Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eget leo at tortor suscipit euismod quis ut augue. Morbi ut enim vel nisi aliquet molestie eget a metus. Suspendisse potenti. Integer ac mauris eget dui auctor luctus nec sed magna. Phasellus suscipit lectus ligula, vel tempus dui aliquam nec. Phasellus mollis scelerisque lacus, quis volutpat ante sagittis et. Aenean pharetra metus sollicitudin, gravida magna in, rutrum magna. Etiam in magna non nisl pellentesque euismod eu sed massa. Sed luctus lectus justo, sed imperdiet tortor convallis non. Sed quis tincidunt justo. Nullam sit amet est id est faucibus dapibus. Suspendisse ultrices mi ultrices pellentesque dignissim. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.

## Markdown Tests

The following section provides some formatting tests the themes and sites. If you are changing styles using Theme-UI you should be able to quickly see changes on this page. Most common markdown elements are included and at the end there is an example blog post to test.
...
This is [an example](https://3200.pro) link.

[This link](https://3200.pro) has no title attribute and is in a longer set of words. Let's see how long I can type before I get bored and stop typing. Here is me filling in some more spaces. And wow we have [encountered another link](https://3200.pro) in the wild!
